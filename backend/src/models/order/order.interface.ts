import { OrderConditionDTO, OrderCreateDTO, OrderUpdateDTO } from "@models/order/order.dto";
...
export interface IOrderRepository extends IQueryRepository, ICommandRepository {}
