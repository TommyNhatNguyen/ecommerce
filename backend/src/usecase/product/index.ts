...
export class ProductUseCase implements IProductUseCase {
  ...
  async updateProduct(id: string, data: ProductUpdateDTOSchema): Promise<Product> {
  ...
  async getProducts(condition: ProductConditionDTOSchema, paging: PagingDTO): Promise<{data: Product[], meta: Meta}> {
