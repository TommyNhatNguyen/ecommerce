...
import { imageInit, imageModelName } from 'src/modules/image/infras/repo/dto';
import {
  CloudinaryImageRepository,
  PostgresImageRepository,
} from 'src/modules/image/infras/repo/repo';
import { ImageHttpService } from 'src/modules/image/infras/transport/image-http.service';
...
import { ImageUseCase } from 'src/modules/image/usecase';
