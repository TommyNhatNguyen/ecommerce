...
export default {
  [LOCALES.VIETNAMESE]: {
    ...
    action: "Hành động",
    update_option: "Cập nhật thuộc tính",
    create_option: "Tạo thuộc tính",
    create_option_failed: "Tạo thuộc tính thất bại",
    create_option_success_description: "Thuộc tính đã được tạo thành công",
    create_option_failed_description: "Không thể tạo thuộc tính",
    delete_option: "Xóa thuộc tính",
    delete_option_success: "Xóa thuộc tính thành công",
    ...
    payment_shipping_info: "Thông tin thanh toán & vận chuyển",
    ...
    other_costs: "Tổng chi phí khác",
    shipping_fee: "Chi phí vận chuyển",
    payment_fee: "Chi phí thanh toán",
